...
import companion.support.v8.animation.ValueAnimatorCompat;
import companion.support.v8.view.animation.AnimatorProxy;

class ViewPropertyAnimatorPreHC extends ViewPropertyAnimatorCompat {
    /**
     ...
     */
    private AnimatorCompat.AnimatorListener mListener = null;
     ...
     */
    private HashMap<AnimatorCompat, PropertyBundle> mAnimatorMap =
            new HashMap<AnimatorCompat, PropertyBundle>();
    ...
    public long getDuration() {
        if (mDurationSet) {
            ...
            return new ValueAnimatorCompat().getDuration();
        }
    }
    ...
    @Override
    public ViewPropertyAnimatorCompat setInterpolator(/*Time*/Interpolator interpolator) {
    ...
    @Override
    public ViewPropertyAnimatorCompat setListener(AnimatorCompat.AnimatorListener listener) {
        mListener = listener;
        return this;
    }
    ...
    public void cancel() {
        if (mAnimatorMap.size() > 0) {
            HashMap<AnimatorCompat, PropertyBundle> mAnimatorMapCopy =
                    (HashMap<AnimatorCompat, PropertyBundle>)mAnimatorMap.clone();
            Set<AnimatorCompat> animatorSet = mAnimatorMapCopy.keySet();
            for (AnimatorCompat runningAnim : animatorSet) {
                runningAnim.cancel();
            }
        }
	...
	private void startAnimation() {
        ValueAnimatorCompat animator = ValueAnimatorCompat.ofFloat(1.0f);
    ...
    private void animatePropertyBy(int constantName, float startValue, float byValue) {
        ...
        if (mAnimatorMap.size() > 0) {
            AnimatorCompat animatorToCancel = null;
            Set<AnimatorCompat> animatorSet = mAnimatorMap.keySet();
            for (AnimatorCompat runningAnim : animatorSet) {
    ...
    private class AnimatorEventListener
            implements AnimatorCompat.AnimatorListener, ValueAnimatorCompat.AnimatorUpdateListener {
        @Override
