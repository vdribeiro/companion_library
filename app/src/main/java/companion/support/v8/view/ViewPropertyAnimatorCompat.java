...
import companion.support.v8.animation.AnimatorCompat;
 ...
 *
 */
public abstract class ViewPropertyAnimatorCompat {
    private static final WeakHashMap<View, ViewPropertyAnimatorCompat> ANIMATORS =
            new WeakHashMap<View, ViewPropertyAnimatorCompat>(0);
	...
	public static ViewPropertyAnimatorCompat animate(View view) {
        ViewPropertyAnimatorCompat animator = ANIMATORS.get(view);
        if (animator == null) {
     ...
     */
    public abstract ViewPropertyAnimatorCompat setDuration(long duration);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat setStartDelay(long startDelay);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat setInterpolator(/*Time*/Interpolator interpolator);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat setListener(AnimatorCompat.AnimatorListener listener);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat x(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat xBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat y(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat yBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat rotation(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat rotationBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat rotationX(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat rotationXBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat rotationY(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat rotationYBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat translationX(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat translationXBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat translationY(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat translationYBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat scaleX(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat scaleXBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat scaleY(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat scaleYBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat alpha(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimatorCompat alphaBy(float value);
}
