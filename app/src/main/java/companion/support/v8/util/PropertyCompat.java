 ...
 */
public abstract class PropertyCompat<T, V> {
     ...
     * {@link NoSuchPropertyExceptionCompat} exception will be thrown.</p>
     */
    public static <T, V> PropertyCompat<T, V> of(Class<T> hostType, Class<V> valueType, String name) {
     ...
     */
    public PropertyCompat(Class<V> type, String name) {
        mName = name;
        mType = type;
    }
     ...
     * NoSuchPropertyExceptionCompat} exception). This may happen if the Property wraps functionality that
